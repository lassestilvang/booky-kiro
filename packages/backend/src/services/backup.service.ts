...
export class BackupService {
   ...
   */
  async generateBackup(userId: string, autoGenerated: boolean = false): Promise<Backup> {
  ...
  private async gatherUserData(userId: string): Promise<BackupData> {
    ...
    const bookmarksWithRelations = await this.bookmarkRepository.findByUserId(userId);
   ...
   */
  private async createBackupArchive(data: BackupData, outputPath: string): Promise<void> {
